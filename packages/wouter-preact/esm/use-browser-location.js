import { a as useSyncExternalStore, u as useEvent } from './preact-deps-dec5c677.js';
import 'preact/hooks';
import 'preact';
...
const useSearchParams = ({ ssrSearch = "" } = {}) => {
...
export { navigate, useBrowserLocation, useHistoryState, useLocationProperty, usePathname, useSearch, useSearchParams };
